...
const { getOwnerBookings, getBookingById, acceptBooking, cancelBooking, startRental, endRental, downloadContract, confirmBooking } = require('../controllers/ownerBookingController');
