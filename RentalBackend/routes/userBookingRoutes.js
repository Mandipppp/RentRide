...
const { createBooking, getUserBooking, getAllBookings, cancelUserBooking, getRenterBookings, getBookingById, getAllVehicleBookings, editPendingBooking, acceptRevisionBooking, requestRefund } = require('../controllers/userBookingController');
...
router.put('/request-refund/:bookingId', authenticate, requestRefund);
